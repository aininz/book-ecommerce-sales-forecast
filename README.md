...
| category             | target    | WAPE (weekly) | winsor_q | winsor_cap | train clipped | sem_window_days |
| -------------------- | --------- | ------------: | -------: | ---------: | ------------: | --------------: |
| Medical              | `qty`     |        19.90% |        - |          - |         0.00% |              28 |
| Medical              | `revenue` |        18.74% |    99.0% | 121,063.15 |         1.09% |              21 |
| Science & Technology | `qty`     |        26.82% |    99.9% |   2,897.25 |         0.14% |              28 |
| Science & Technology | `revenue` |        26.85% |    99.5% | 135,276.51 |         0.55% |               7 |

| category             | target    | seasonality_mode | yearly_seasonality | use_monthly | use_semester | changepoint_prior_scale | seasonality_prior_scale |
| -------------------- | --------- | ---------------- | ------------------ | ----------- | ------------ | ----------------------: | ----------------------: |
| Medical              | `qty`     | multiplicative   | No                 | No          | Yes          |                    0.05 |                      10 |
| Medical              | `revenue` | multiplicative   | Yes                | Yes         | No           |                    0.10 |                       1 |
| Science & Technology | `qty`     | additive         | Yes                | No          | Yes          |                    0.10 |                      10 |
| Science & Technology | `revenue` | additive         | Yes                | No          | Yes          |                    0.10 |                       5 |
